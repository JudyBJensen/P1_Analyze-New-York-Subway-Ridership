...
# sizing for AB project
#gross
required_size(s=0.0202*sqrt(400), d_min=0.01, Ns=seq(10, 500000, 100))
#net
required_size(s=0.0156*sqrt(400), d_min=0.075, Ns=seq(10, 500000, 100))
#gross, alpha = 2.5
required_size(s=0.0202*sqrt(400), d_min=0.01, Ns=seq(10, 500000, 100), alpha=0.025)
#net, alpha = 2.5
required_size(s=0.0156*sqrt(400), d_min=0.075, Ns=seq(10, 500000, 100), alpha=0.025)